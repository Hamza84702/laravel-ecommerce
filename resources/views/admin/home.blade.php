                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                          ...
                          <p class="text-success ml-2 mb-0 font-weight-medium">{{$deliveredPercentage}}%</p>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                          ...
                          <p class="text-primary ml-2 mb-0 font-weight-medium">{{$processingPercentage}}%</p>
                        </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                          <h2 class="mb-0">{{$dispatchgorders}}</h2>
                          <p class=" ml-2 mb-0 font-weight-medium" style="color:orange;">{{$dispatchPercentage}}% </p>
                        </div>
